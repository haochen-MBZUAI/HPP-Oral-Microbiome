...
# --- Step 2.2: Identify Significant Oral Markers (per fold, training-selected phenotypes) ---
print(f"\nStep 2.2: Filtering for significant {LAYER} markers linked to top phenotypes (per fold)...")
union_pathways = set()
any_found = False
